...
```bash
git clone https://github.com/sahibpreetsingh12/voice-cursor.git
cd voice-cursor
...
[Report Bug](https://github.com/sahibpreetsingh12/voice-cursor/issues) · [Request Feature](https://github.com/sahibpreetsingh12/voice-cursor/issues) · [View Demo](#)
